...
private static final Logger LOGGER = LoggerFactory.getLogger(YeskySpider.class);
	...
	public static void parserUrl(String url){
		...
		Elements elements =  document.select("#listtu dd a");
		...
		Elements eleA =  document.select("#boxz font a");
	...
	public static void main(String[] args) {
		...
		parserUrl("http://pic.yesky.com/c/6_61100.shtml");
	}
